...
class ModuleML(object):
    ...
    def train_model(self, filepath):
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/train_x', 'wb') as data:
            bucket.download_fileobj('train_x', data)
        train_x = load(open('authentication/pickled_data/train_x', "r"))
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/train_y', 'wb') as data:
            bucket.download_fileobj('train_y', data)

        print np.shape(train_x)
        train_y = load(open('authentication/pickled_data/train_y', "r"))
        print np.shape(train_y)
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/class', 'wb') as data:
        ...
        dump(train_x, open('authentication/pickled_data/train_x', "w"))
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/train_x', "rb") as data2:
            bucket.upload_fileobj(data2, 'train_x')
        dump(train_y, open('authentication/pickled_data/train_y', "w"))
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/train_y', "rb") as data2:
            bucket.upload_fileobj(data2, 'train_y')
        dump(class_values, open('authentication/pickled_data/class', "w"))
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/class', "rb") as data2:
            bucket.upload_fileobj(data2, 'class')

        try:
            os.remove('/home/sam/ws/VoiAuth/authentication/pickled_data/train_x')
            os.remove('/home/sam/ws/VoiAuth/authentication/pickled_data/train_y')
            os.remove('/home/sam/ws/VoiAuth/authentication/pickled_data/class')
        except:
            print "Delete failed"
    ...
    def GBM_run(self):
        ...
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/model', "rb") as data2:
            bucket.upload_fileobj(data2, 'model')
        os.remove('/home/sam/ws/VoiAuth/authentication/pickled_data/model')

    def predict(self, filepath, actual):
        with open('/home/sam/ws/VoiAuth/authentication/pickled_data/model', 'wb') as data:
